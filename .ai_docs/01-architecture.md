...
| layout (MOD2) | `lumen_layout::LayoutEngine` | 7 required + 5 defaulted methods | `lumen-layout/tests/engine_seam.rs` |
...
spending the 5.87 MB on syntax. What follows is the audit that prompted it: Auditing them by trying to *use* one found three defects: (1)
