...
| `ui.lint` | `{}` | `{ findings: [{code, message}] }` (layout/contrast audits: W0103/W0104/W0105/W0301, **W0110** oversize sprite, **W0303** unreadable text contrast — APCA vs the composited backdrop, **W0111** effectively-transparent node). In a `dev-observability` build these are also **pushed** to `app.logs` as they appear (O0.3) |
